...
df_juigalpa_ineter = read.xlsx(sprintf("%s%s",getwd(), "/data/precipitationMonthly/PRECIPITACION - Juigalpa INETER (2002-2019).xlsx")) 
df_juigalpa_trmm = read.xlsx(sprintf("%s%s",getwd(), "/data/precipitationMonthly/PRECIPITACION - Juigalpa TRMM (2002-2019).xlsx"))
df_managua_chirps = read.xlsx(sprintf("%s%s",getwd(), "/data/precipitationMonthly/PRECIPITACION - Managua CHIRPS (2002-2019).xlsx"))
df_managua_ineter = read.xlsx(sprintf("%s%s",getwd(), "/data/precipitationMonthly/PRECIPITACION - Managua INETER (2002-2019).xlsx"))
df_managua_trmm = read.xlsx(sprintf("%s%s",getwd(), "/data/precipitationMonthly/PRECIPITACION - Managua TRMM (2002-2019).xlsx"))

column_name_values <- "Valor"
...
saveWorkbook(wb, "R Mann Kendall Precipitacion Monthly Test.xlsx", overwrite = TRUE)
